...
#    hal.Pin('bb_gpio.p9.in-13').link('limit-2-home')   # Z
    ...
    hal.Pin('bb_gpio.p8.in-08.invert').set(1)
    hal.Pin('bb_gpio.p8.in-07.invert').set(1)
    hal.Pin('bb_gpio.p8.in-10.invert').set(1)
    hal.Pin('bb_gpio.p8.in-09.invert').set(1)
    hal.Pin('bb_gpio.p9.in-13.invert').set(1)
    hal.Pin('bb_gpio.p9.in-11.invert').set(1)

    # ADC
    hal.Pin('temp.ch-05.value').link('hbp-temp-meas')
    hal.Pin('temp.ch-04.value').link('e0-temp-meas')
    hal.Pin('temp.ch-03.value').link('e1-temp-meas')
    hal.Pin('temp.ch-02.value').link('e2-temp-meas')
